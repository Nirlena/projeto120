...
def preprocess_user_input(user_input):
    user_input_1 = nltk.word_tokenize(user_input)
    user_input_2 = get_stem_words(user_input_1, ignore_words) 
    user_input_2 = sorted(list(set(user_input_2)))

    bag=[]
    bag_of_words = []
    # Codificação dos dados de entrada 
    for word in words:            
        if word in user_input_2:              
